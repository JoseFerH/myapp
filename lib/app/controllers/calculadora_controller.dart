...
class CalculadoraController extends GetxController {
  ...
  Rx<LaminadoModel?> get laminadoSeleccionada => _calculadoraService.laminadoSeleccionada;
  Rx<TamanoSticker> get tamanoSeleccionado => _calculadoraService.tamanoSeleccionado;
  ...
  void onInit() async {
    ...
    try {
      ...
      await _calculadoraService.init();
