...
class CarritoController extends GetxController {
  ...
  Rx<ClienteModel?> get clienteSeleccionado =>
      _carritoService.clienteSeleccionado;
  Rx<TipoEnvio> get tipoEnvio => _carritoService.tipoEnvio;
  RxDouble get costoEnvioPersonalizado =>
      _carritoService.costoEnvioPersonalizado;
  ...
  RxDouble get costoEnvioNormal => _carritoService.costoEnvioNormal;
  RxDouble get costoEnvioExpress => _carritoService.costoEnvioExpress;
  ...
  void onInit() async {
    ...
    try {
      ...
      // Actualizar la configuración para asegurar que los precios de envío estén correctos
      await _carritoService.actualizarConfiguracion();
  ...
  // Actualizar configuración de precios de envío
  Future<void> actualizarPreciosEnvio() async {
    await _carritoService.actualizarConfiguracion();
  }
  ...
  Future<void> generarCotizacion() async {
    try {
      ...
      VentaModel? venta = await Get.find<VentaService>().cargarVentaPorId(
        ventaId,
      );
